...
static const int MOVES_ARRAY_LENGTH = 240;

static const unsigned long long A8 = 0x8000000000000000;

static const unsigned long long RANK_1 = 0x00000000000000FF;
static const unsigned long long RANK_2 = 0x000000000000FF00;
static const unsigned long long RANK_3 = 0x0000000000FF0000;
static const unsigned long long RANK_4 = 0x00000000FF000000;
static const unsigned long long RANK_5 = 0x000000FF00000000;
static const unsigned long long RANK_6 = 0x0000FF0000000000;
static const unsigned long long RANK_7 = 0x00FF000000000000;
static const unsigned long long RANK_8 = 0xFF00000000000000;

static const unsigned long long RANKS[] = {RANK_1,RANK_2,RANK_3,RANK_4,RANK_5,RANK_6,RANK_7,RANK_8};

static const unsigned long long FILE_A = 0x8080808080808080;
static const unsigned long long FILE_B = 0x4040404040404040;
static const unsigned long long FILE_C = 0x2020202020202020;
static const unsigned long long FILE_D = 0x1010101010101010;
static const unsigned long long FILE_E = 0x0808080808080808;
static const unsigned long long FILE_F = 0x0404040404040404;
static const unsigned long long FILE_G = 0x0202020202020202;
static const unsigned long long FILE_H = 0x0101010101010101;

static const unsigned long long FILES[] = {FILE_H,FILE_G,FILE_F,FILE_E,FILE_D,FILE_C,FILE_B,FILE_A};

static const unsigned long long DIAGS_UP[] = {0,
                                              0x102,
                                              0x10204,
                                              0x1020408,
                                              0x102040810,
...
static const unsigned long long DIAGS_DOWN[] = {0,
                                                0x8040,
                                                0x804020,
                                                0x80402010,
                                                0x8040201008,
...
static const int WHITE_PCS = 12;
static const int BLACK_PCS = 13;

static const int WHITE_ATTACKERS = 14;
static const int BLACK_ATTACKERS = 15;

static const int INFO = 16;

int BOARD_ARRAY_SIZE = INFO + 1;

static const char* SQUARES[64] = {"h1","g1","f1","e1","d1","c1","b1","a1",
...
static const unsigned long long WHITE_KINGSIDE_SPACE = 0b110ULL;
static const unsigned long long WHITE_QUEENSIDE_SPACE = 0b01110000ULL;
static const unsigned long long BLACK_KINGSIDE_SPACE = 0b110ULL << 56;
static const unsigned long long BLACK_QUEENSIDE_SPACE = 0b01110000ULL << 56;

static const unsigned long long WHITE_KINGSIDE_ATTACKED = 0b1110ULL;
static const unsigned long long WHITE_QUEENSIDE_ATTACKED = 0b10111000ULL;
static const unsigned long long BLACK_KINGSIDE_ATTACKED = 0b1110ULL << 56;
static const unsigned long long BLACK_QUEENSIDE_ATTACKED = 0b00111000ULL << 56;

static const unsigned long long WHITE_KINGSIDE_RIGHT =  0b00001;
static const unsigned long long WHITE_QUEENSIDE_RIGHT = 0x80;
static const unsigned long long BLACK_KINGSIDE_RIGHT =  0x1ULL << 56;
static const unsigned long long BLACK_QUEENSIDE_RIGHT = 0x80ULL << 56;

static const unsigned long long TURN_BIT = 2;

static const char PIECE_NAMES[15][15] = {
  "White Pawn",
  "White Knight",
  "White Bishop",
  "White Rook",
...
static const int mg_white_pawn_table[64] = {
...
static const int eg_white_pawn_table[64] = {
...
static const int mg_white_knight_table[64] = {
...
static const int eg_white_knight_table[64] = {
...
static const int mg_white_bishop_table[64] = {
...
static const int eg_white_bishop_table[64] = {
...
static const int mg_white_rook_table[64] = {
...
static const int eg_white_rook_table[64] = {
...
static const int mg_white_queen_table[64] = {
  ...
  1011, 1027, 1014, 1023, 1020, 1023, 1039, 1030,
   990, 1017, 1036, 1027, 1033, 1040, 1022, 1026,
  1024, 1007, 1016, 1035, 1010, 1000,  994,  975,
 };
 
static const int eg_white_queen_table[64] = {
...
static const int mg_white_king_table[64] = {
...
static const int eg_white_king_table[64] = {
...
static const int mg_black_king_table[64] = {
   -15,   36,   12,  -54,    8,  -28,   24,   14,
     1,    7,   -8,  -64,  -43,  -16,    9,    8,
   -14,  -14,  -22,  -46,  -44,  -30,  -15,  -27,
   -49,   -1,  -27,  -39,  -46,  -44,  -33,  -51,
...
static const int eg_black_king_table[64] = {
   -53,  -34,  -21,  -11,  -28,  -14,  -24,  -43,
   -27,  -11,    4,   13,   14,    4,   -5,  -17,
   -19,   -3,   11,   21,   23,   16,    7,   -9,
   -18,   -4,   21,   24,   27,   23,    9,  -11,
...
static const int mg_black_pawn_table[64] = {
    82,   82,   82,   82,   82,   82,   82,   82,
    47,   81,   62,   59,   67,  106,  120,   60,
    56,   78,   78,   72,   85,   85,  115,   70,
    55,   80,   77,   94,   99,   88,   92,   57,
...
static const int eg_black_pawn_table[64] = {
    94,   94,   94,   94,   94,   94,   94,   94,
   107,  102,  102,  104,  107,   94,   96,   87,
    98,  101,   88,   95,   94,   89,   93,   86,
   107,  103,   91,   87,   87,   86,   97,   93,
...
static const int mg_black_rook_table[64] = {
   458,  464,  478,  494,  493,  484,  440,  451,
   433,  461,  457,  468,  476,  488,  471,  406,
   432,  452,  461,  460,  480,  477,  472,  444,
   441,  451,  465,  476,  486,  470,  483,  454,
...
static const int eg_black_rook_table[64] = {
   503,  514,  515,  511,  507,  499,  516,  492,
   506,  506,  512,  514,  503,  503,  501,  509,
   508,  512,  507,  511,  505,  500,  504,  496,
   515,  517,  520,  516,  507,  506,  504,  501,
...
static const int mg_black_bishop_table[64] = {
   332,  362,  351,  344,  352,  353,  326,  344,
   369,  380,  381,  365,  372,  386,  398,  366,
   365,  380,  380,  380,  379,  392,  383,  375,
   359,  378,  378,  391,  399,  377,  375,  369,
...
static const int eg_black_bishop_table[64] = {
   274,  288,  274,  292,  288,  281,  292,  280,
   283,  279,  290,  296,  301,  288,  282,  270,
   285,  294,  305,  307,  310,  300,  290,  282,
   291,  300,  310,  316,  304,  307,  294,  288,
...
static const int mg_black_knight_table[64] = {
   232,  316,  279,  304,  320,  309,  318,  314,
   308,  284,  325,  334,  336,  355,  323,  318,
   314,  328,  349,  347,  356,  354,  362,  321,
   324,  341,  353,  350,  365,  356,  358,  329,
...
static const int eg_black_knight_table[64] = {
   252,  230,  258,  266,  259,  263,  231,  217,
   239,  261,  271,  276,  279,  261,  258,  237,
   258,  278,  280,  296,  291,  278,  261,  259,
   263,  275,  297,  306,  297,  298,  285,  263,
...
static const int mg_black_queen_table[64] = {
  1024, 1007, 1016, 1035, 1010, 1000,  994,  975,
   990, 1017, 1036, 1027, 1033, 1040, 1022, 1026,
  1011, 1027, 1014, 1023, 1020, 1023, 1039, 1030,
  1016,  999, 1016, 1015, 1023, 1021, 1028, 1022,
...
static const int eg_black_queen_table[64] = {
   903,  908,  914,  893,  931,  904,  916,  895,
   914,  913,  906,  920,  920,  913,  900,  904,
   920,  909,  951,  942,  945,  953,  946,  941,
   918,  964,  955,  983,  967,  970,  975,  959,
...
static const int *mg_piece_tables[12] = {mg_white_pawn_table,mg_white_knight_table,mg_white_bishop_table,mg_white_rook_table,mg_white_queen_table,mg_white_king_table,
                                  mg_black_pawn_table,mg_black_knight_table,mg_black_bishop_table,mg_black_rook_table,mg_black_queen_table,mg_black_king_table};

static const int *eg_piece_tables[12] = {eg_white_pawn_table,eg_white_knight_table,eg_white_bishop_table,eg_white_rook_table,eg_white_queen_table,eg_white_king_table,
                                  eg_black_pawn_table,eg_black_knight_table,eg_black_bishop_table,eg_black_rook_table,eg_black_queen_table,eg_black_king_table};
const int mg_to_eg_values[] = {0,0,2,2,4,8,0,0,2,2,4,8};

const unsigned long long KING_MOVES[64] = {
...
const unsigned long long KNIGHT_MOVES[64] = {
...
const unsigned char SLIDING_MOVES[512] = {
